...
class BrainTumorClassifier(L.LightningModule):
    """
    BrainTumorClassifier module using a pre-trained ResNet-18 model for multiclass brain tumor classification.
    ...
    def __init__(self, lr: float = 1e-3):
        ...
        self.model = timm.create_model("resnet18", pretrained=True, num_classes=4)
